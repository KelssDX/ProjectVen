import { z } from 'zod';
import { ConnectionStatusSchema, UserTypeSchema } from '../contracts/enums';

export const ConnectionListQuerySchema = z.object({
  search: z.string().trim().max(120).optional(),
});

export const CreateConnectionRequestBodySchema = z.object({
  addresseeId: z.uuid(),
...
export type TopicFollowToggleResponse = z.infer<
  typeof TopicFollowToggleResponseSchema
>;
